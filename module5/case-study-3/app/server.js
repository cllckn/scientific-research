...
const KAFKA_INPUT_TOPIC  = process.env.KAFKA_INPUT_TOPIC  || "sr-ml-model-input";
const KAFKA_OUTPUT_TOPIC = process.env.KAFKA_OUTPUT_TOPIC || "sr-ml-model-output";
...
const startKafkaPredictionListener = async () => {
    ...
    console.log(`Kafka consumer listening on topic: ${KAFKA_OUTPUT_TOPIC}`);
};
